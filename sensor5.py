...
# Loop untuk membaca semua sensor berulang kali
while True:
    print("############")
    ...
    print("############")
    time.sleep(10)  # Tunggu 5 detik sebelum pembacaan berikutnya

# Tutup komunikasi serial (tidak akan dicapai di loop infinite ini)
ser.close()
